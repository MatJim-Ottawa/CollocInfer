...
%           portion
          ...
          f.fn = thisODE.doWork(thisODE.DE_Symbolic);
          f.dfdx = thisODE.doWork(dfdx);
...
%         Something with null length, need to handle error!
        ...
        function [out] = doWork(thisODE,fn_in)
            ...
            output = thisODE.find_functions(F);
            
            out = str2func([s,F(output{1}.param_end_index+1:end)]); 
        end
        ...
        function [output_] = find_functions(thisODE,aCharString )
            ...
            for i=1:length(o1)
               ...
               % disp(['Parameters:' aCharString( param_start_index:param_end_index)])
                ...
                params = thisODE.find_parameters( params_string );
